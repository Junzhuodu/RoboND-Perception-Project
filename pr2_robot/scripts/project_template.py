...
def pcl_callback(pcl_msg):
    ...
    ######### Create a Passthrough filter object on y axis.
    passthrough = cloud_filtered.make_passthrough_filter()
...
def pr2_mover(object_list):
    ...
    for i in range(len(object_list_param)):
        ...
        pick_pose = Pose() # Initialize pick_pose
        ...
        place_pose = Pose() # Initialize place_pose
        arm_name = String() # Initialize arm_name
        for k in range(len(dropbox_list_param)):
            if object_group.data == dropbox_list_param[k]['group']:
                place_pose.position.x = dropbox_list_param[k]['position'][0]
                place_pose.position.x = dropbox_list_param[k]['position'][1]
                place_pose.position.x = dropbox_list_param[k]['position'][2]
